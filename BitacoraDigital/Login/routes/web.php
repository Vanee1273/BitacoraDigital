...
use App\Http\Controllers\IncidenciasController; // Asegúrate de importar el controlador

// Ruta principal (actualizada para usar Vistas.Inicio)
Route::get('/', function () {
    return view('Vistas.Inicio');
})->name('inicio');

// Ruta para crear incidencias
