                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @foreach ($incidencias as $incidencia)
                            ...
                            <div class="modal fade" id="editIncidentModal{{ $incidencia->id }}" tabindex="-1" aria-labelledby="editIncidentModalLabel{{ $incidencia->id }}" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('incidencias.store') }}">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Motivo</label>
                        <input type="text" class="form-control" name="Motivos" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Descripción</label>
                        <textarea class="form-control" name="Descripción" rows="3" required></textarea>
                    </div>
